/**
 * TypeScript contracts for the Arx CA Go backend (/api/v1).
 * These mirror the Go models in `internal/models` and are the single source
 * of truth for request/response shapes used by the API client layer.
 */
...
export interface CAPemResponse {
  pem: string
}
