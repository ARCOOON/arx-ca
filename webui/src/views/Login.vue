  ...
  <div class="flex min-h-screen items-center justify-center bg-background px-4 py-12">
    <div class="w-full max-w-md">
      <div class="mb-8 text-center">
        <div class="mx-auto mb-4 flex size-14 items-center justify-center rounded-md border border-border bg-card">
          <ShieldCheck class="size-7 text-primary" aria-hidden="true" />
        </div>
        <h1 class="font-heading text-2xl font-semibold tracking-tight">Arx Certificate Authority</h1>
