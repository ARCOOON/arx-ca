...
func newTrustCmd() *cobra.Command {
	...
	trust.AddCommand(
		newTrustInstallCmd("root", "Root", agenttrust.InstallRoot),
		newTrustInstallCmd("intermediate", "Intermediate", agenttrust.InstallIntermediate),
		newTrustUninstallCmd("root", "Root", agenttrust.UninstallRoot),
		newTrustUninstallCmd("intermediate", "Intermediate", agenttrust.UninstallIntermediate),
	)
	return trust
}
